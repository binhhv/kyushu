...
class chart {
    ...
    function draw_chart($params){
        ...
        //$Test->setLineStyle(2); 
        $Test->setFontProperties(APPPATH."libraries/pChart/meiryo.ttc",8);   
        ...
        // Draw the 0 line   
        $Test->setFontProperties(APPPATH."libraries/pChart/meiryo.ttc",6);   
       ...
       // $Test->drawLegend(75,35,$DataSet->GetDataDescription(),255,255,255);   
        $Test->setFontProperties(APPPATH."libraries/pChart/meiryo.ttc",10);   
