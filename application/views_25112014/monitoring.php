		...
		//alert('123');
         ...
         success:function(data){
                    //alert('right');
                        ...
                        $('#lb_mon2').html(arrayData[1]);
                        $('#lb_mon3').html(arrayData[2]);
                        $('#lb_mon4').html(arrayData[3]);
...
<body onload="startTime()">
    <h1 id="h01"></h1>
    <div id ="autodata"><?php //echo $max;//print_r($monitor);// count($monitor); ?></div>
  <div class="wrapper">
  ...
  <div class="box sen-box">
    ...
    <div class="row">
      <div class="left">
        ...
        <p><strong><label id="lb_mon1"><?php echo $value['mon01']; ?></label></strong>μSv/h</p>
        <div class="btn-g24">
      ...
      <div class="right">
        ...
        <p><strong><label id="lb_mon2"><?php echo $value['mon02']; ?></label></strong>μSv/h</p>
        <div class="btn-g24">
  ...
  <div class="box sen-box">
    ...
    <div class="row">
      <div class="left">
        ...
        <p><strong><label id="lb_mon3"><?php echo $value['mon03']; ?></label></strong>μSv/h</p>
        <div class="btn-g24">
      ...
      <div class="right">
        ...
        <p><strong><label id="lb_mon4"><?php echo $value['mon04']; ?></label></strong>μSv/h</p>
        <div class="btn-g24">
...
<div class="remodal" data-remodal-id="graph1">
  <p class="modal-title">最新24時間線量　1号機</p>
...
<div class="remodal" data-remodal-id="graph2">
  <p class="modal-title">最新24時間線量　2号機</p>
...
<div class="remodal" data-remodal-id="graph3">
  <p class="modal-title">最新24時間線量　3号機</p>
...
<div class="remodal" data-remodal-id="graph4">
  <p class="modal-title">最新24時間線量　4号機</p>
