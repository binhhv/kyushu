...
<script>
       function changeCalendar(type,valueType){
           ...
           $.ajax({
            ...
            data:{type: type,valueType:valueType,currentMonth: currentMonth, currentYear:currentYear},
...
<div class="box sen-box-arc">
    ...
    <p class="graph-title">最新24時間線量　<label id="ilb_mon" >1</label>号機</p>
    <div class="tac"><img src="<?php echo base_url(); ?>assets/img/loading_icon_comment.gif" width="562" height="188" alt="" id="img_chartDay"></div>
    <form action="<?php echo site_url('monitoring/archive'); ?>" method="post" id ="formMain">
