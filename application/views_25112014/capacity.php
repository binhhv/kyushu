...
<head>
  ...
  <title>  定員・現員表 | 九州大学アイソトープ総合センター</title>
...
<link rel="alternate" type="application/rss+xml" title="九州大学アイソトープ総合センター &raquo; 定員・現員表 のコメントのフィード" href="http://qu.workmanage.biz/system/summary/capacity/feed" />
<link rel='canonical' href='<?php echo site_url('summary/capacity')?>' />
<link rel='shortlink' href='http://qu.workmanage.biz/system/?p=55' />
...
<li id="menu-item-81" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-55 current_page_item menu-item-81"><a href="<?php echo site_url('summary/capacity')?>">定員・現員表</a></li>
...
<li id="menu-item-83" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-83"><a href="<?php echo site_url('summary/manager')?>">歴代室長</a></li>
