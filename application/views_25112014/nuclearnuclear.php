...
<head>
  ...
  <title>  核燃料安全管理部 | 九州大学アイソトープ総合センター</title>
...
<link rel="alternate" type="application/rss+xml" title="九州大学アイソトープ総合センター &raquo; 核燃料安全管理部 のコメントのフィード" href="http://qu.workmanage.biz/system/nuclearnuclear/feed" />
<link rel='canonical' href='<?php echo site_url('nuclearnuclear')?>' />
<link rel='shortlink' href='http://qu.workmanage.biz/system/?p=110' />
...
<li id="menu-item-202" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-202"><a href="http://qu.workmanage.biz/system/inquiry">お問い合わせ</a></li>
  ...
  <div class="contents page page-110">
    <div class="breadcrumbs set-width" xmlns:v="http://rdf.data-vocabulary.org/#">
        <!-- Breadcrumb NavXT 5.1.1 -->
<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Go to 九州大学アイソトープ総合センター." href="http://qu.workmanage.biz/system" class="home">TOP</a></span> &gt; <span typeof="v:Breadcrumb"><span property="v:title">核燃料安全管理部</span></span>    </div>
