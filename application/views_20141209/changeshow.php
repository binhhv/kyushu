    ...
    <body>
        ...
        <div class="container" style="margin-top: 50px; height: 200px">
            ...
            <select name="taskOption" id="taskOption">
              <option value="mon01" <?php if (isset($name) && $name=="mon01") echo 'selected="selected"';?>>1号機</option>
              <option value="mon02"  <?php if (isset($name) && $name=="mon02") echo 'selected="selected"';?>>2号機</option>
              <option value="mon03" <?php if (isset($name) && $name=="mon03") echo 'selected="selected"';?>>3号機</option>
              <option value="mon04" <?php if (isset($name) && $name=="mon04") echo 'selected="selected"';?>>4号機</option>
            </select>
