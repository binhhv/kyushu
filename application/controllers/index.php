...
//        }
    ...
    public function insertAirFile() {
        ...
        $dirPath1 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATA/$mon01/";
        $dirPath2 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATA/$mon02/";
        $dirPath3 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATA/$mon03/";
        $dirPath4 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATA/$mon04/";
        $dirPath5 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATA/$mon05/";
        ...
        if (file_exists($dirPath1)) {
            ...
            while (($currentFile = readdir($dir)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    $files1 = $currentFile;
                    $filescheck1 = "mon00" . "_" . $files1;
                    $data = (String) $this->airmodel->getAirByString($filescheck1);
                    $dataSpace = (String) $this->airmodel->getAirByString($filescheck1);
                    if (strcmp($data, "1")) {
                        $this->parse_Airfile($files1, $dirPath1, $filescheck1);
                    } else if (strcmp($dataSpace, "1")) {
                        $this->parse_Airfile($files1, $dirPath1, $filescheck1);
                    }
                }
            }
        ...
        if (file_exists($dirPath2)) {
            ...
            while (($currentFile = readdir($dir2)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    $files2 = $currentFile;
                    $filescheck2 = "mon01" . "_" . $files2;
                    $data = (String) $this->airmodel->getAirByString($filescheck2);
                    $dataSpace = (String) $this->airmodel->getAirByString($filescheck2);
                    if (strcmp($data, "1")) {
                        $this->parse_Airfile($files2, $dirPath2, $filescheck2);
                    } else if (strcmp($dataSpace, "1")) {
                        $this->parse_Airfile($files2, $dirPath2, $filescheck2);
                    }
                }
        ...
        if (file_exists($dirPath3)) {
            ...
            while (($currentFile = readdir($dir3)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    $files3 = $currentFile;
                    $filescheck3 = "mon02" . "_" . $files3;
                    $data = (String) $this->airmodel->getAirByString($filescheck3);
                    $dataSpace = (String) $this->airmodel->getAirByString($filescheck3);
                    if (strcmp($data, "1")) {
                        $this->parse_Airfile($files3, $dirPath3, $filescheck3);
                    } else if (strcmp($dataSpace, "1")) {
                        $this->parse_Airfile($files3, $dirPath3, $filescheck3);
                    }
                }
        ...
        if (file_exists($dirPath4)) {
            ...
            while (($currentFile = readdir($dir4)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    $files4 = $currentFile;
                    $filescheck4 = "mon03" . "_" . $files4;
                    $data = (String) $this->$this->airmodel->getAirByString($filescheck4);
                    $dataSpace = (String) $this->airmodel->getAirByString($filescheck4);
                    if (strcmp($data, "1")) {
                        $this->parse_Airfile($files4, $dirPath4, $filescheck4);
                    } else if (strcmp($dataSpace, "1")) {
                        $this->parse_Airfile($files4, $dirPath4, $filescheck4);
                    }
                }
        ...
        if (file_exists($dirPath5)) {
            ...
            while (($currentFile = readdir($dir5)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    $files5 = $currentFile;
                    $filescheck5 = "mon04" . "_" . $files5;
                    $data = (String) $this->airmodel->getAirByString($filescheck5);
                    $dataSpace = (String) $this->airmodel->getAirByString($filescheck5);
                    if (strcmp($data, "1")) {
                        $this->parse_Airfile($files5, $dirPath5, $filescheck5);
                    } else if (strcmp($dataSpace, "1")) {
                        $this->parse_Airfile($files5, $dirPath5, $filescheck5);
                    }
                }
        ...
        $dirPathupdate1 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon01/";
        $dirPathupdate2 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon02/";
        $dirPathupdate3 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon03/";
        $dirPathupdate4 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon04/";
        $dirPathupdate5 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon05/";
        $this->getAllFileAirUpdate($dirPathupdate1, "mon00", $mon01);
        $this->getAllFileAirUpdate($dirPathupdate2, "mon01", $mon02);
        $this->getAllFileAirUpdate($dirPathupdate3, "mon02", $mon03);
        $this->getAllFileAirUpdate($dirPathupdate4, "mon03", $mon04);
        $this->getAllFileAirUpdate($dirPathupdate5, "mon04", $mon05);
...
//        $dirPath2 = $_SERVER["DOCUMENT_ROOT"]."/dataold/";
        ...
        $dirPathmove1 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYOLDDATA/$mon01/";
        $dirPathmove2 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYOLDDATA/$mon02/";
        $dirPathmove3 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYOLDDATA/$mon03/";
        $dirPathmove4 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYOLDDATA/$mon04/";
        $dirPathmove5 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYOLDDATA/$mon05/";

        $this->moveAirFile($dirPath1, $dirPathmove1, "mon00");
        $this->moveAirFile($dirPath2, $dirPathmove2, "mon01");
        $this->moveAirFile($dirPath3, $dirPathmove3, "mon02");
        $this->moveAirFile($dirPath4, $dirPathmove4, "mon03");
        $this->moveAirFile($dirPath5, $dirPathmove5, "mon04");
    }

    //insert airSpaceFile
    public function insertAirSpaceFile() {
        
    }

    //update airFile
    public function updateAirFile() {
        
    }

    //update airSpace File
    public function updateAirSpaceFile() {
        
    }

    //move air File
    public function moveAirFile($folder1, $folder2, $namefile) {
        ...
        if (file_exists($folder1)) {
            ...
            while (($currentFile = readdir($dir)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    ...
                    if (count($strdata) == 3) {
                        $strdate = $strdata[1];
                        $strtypeName = $strdata[2];
//                        $strdate = $strdatehour[2];
//                        $strdatehour = explode('_', $strdatehour);
//                        if(count($strdatehour) == 2){
                        if ($strtypeName == "air.csv") {
                            if (strlen($strdate) == 6) {
                                $year = substr($strdate, 0, 4);
                                $month = substr($strdate, 4, 2);
                                $data = $this->airmodel->getAirByName($value);
                                $data = $data['namesearch'];
                                $today = getdate();
                                $currenday = $today['mday'];
                                $currenmon = $today['mon'];
                        ...
                        } else if ($strtypeName == "space.csv") {
                            if (strlen($strdate) == 6) {
                                $year = substr($strdate, 0, 4);
                                $month = substr($strdate, 4, 2);
                                $data = $this->airmodel->getAirSpaceByName($value);
                                $data = $data['namesearch'];
                                $today = getdate();
                                $currenday = $today['mday'];
                                $currenmon = $today['mon'];
...
//                        }
    ...
    //parse AirFile
    function parse_Airfile($value, $dirPath1, $namefile) {
        $content = "";
        if (file_exists($dirPath1 . $value)) {

            $strdata = explode('_', $namefile);
            if (count($strdata) == 3) {
                $strnameMonitor = $strdata[0];
                $strdate = $strdata[1];
                $strtypeName = $strdata[2];
                if ($strtypeName == "air.csv") {
                    if (strlen($strdate) == 6) {
                        ...
                        if ($data != $value) {
                            $param['year'] = $year;
                            $param['month'] = $month;
                            $param['airdata'] = $content;
                            $param['unit'] = "μSv/h";
                            $param['idmonitor'] = $strnameMonitor;
                            $param['namesearch'] = $namefile;
                            $this->airmodel->insertAirModel($param);
                        }
                    }
                } else if ($strtypeName == "space.csv") {
                    if (strlen($strdate) == 6) {
                        $year = substr($strdate, 0, 4);
                        $month = substr($strdate, 4, 2);
                        $data = $this->airmodel->getAirSpaceLast();
                        $file = fopen($dirPath1 . $value . "", "r");
                        $array_data = fgetcsv($file);
                        $content = $arrayValue[$this->strstr_replica($value, '_', true)] = (float) $array_data[0];
                        fclose($file);
    ...
    //update all file Air
    public function getAllFileAirUpdate($dirPath2, $name, $mon) {
//        $dirPath2 = $_SERVER["DOCUMENT_ROOT"]."/dataupdateold/";
        $files = '';
        if (file_exists($dirPath2)) {
            $dirupdate = $dirPath2;
            ...
            while (($currentFile = readdir($dirupdate)) !== false) {
                if ($this->endsWith($currentFile, '.csv')) {
                    $files = $name . "_" . $currentFile;
                    $data = $this->airmodel->getAirByName($files);
                    $dataSpace = $this->airmodel->getAirSpaceByName($files);

                    $datavalue = $data['namesearch'];
                    
                    $datavalueSpace = $dataSpace['namesearch'];
                    if ($datavalue == $files) {
                        $file = explode("_", $datavalue);
                        $file = $file[1] . $file[2];
                        $this->update_file_Air($files, $mon);
                    }else if($datavalueSpace == $files){
                         $file = explode("_", $datavalueSpace);
                        $file = $file[1] . $file[2];
                        $this->update_file_Air($files, $mon);
                    }
                }
    ...
    public function update_file_Air($value, $mon) {
        $content = "";
//        if (file_exists($_SERVER["DOCUMENT_ROOT"]."/dataupdateold/".$value.""))
//        {
        $strdata = explode('_', $value);
...
//                $strdatehour = explode('_', $strdatehour);
            ...
            $strnameFileAir = $strdata[2];
            if ($strnameFileAir == "air.csv") {
                $namefile = $strdate . "" . $strnameFileAir;
                if (strlen($strdate) == 6) {
                    $year = substr($strdate, 0, 4);
                    $month = substr($strdate, 4, 2);
                    ...
                    $currentfile = explode("_", $value);
                    $currentfile = $currentfile[1] . "_" . $currentfile[2];
                    $file = fopen($_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon/" . $currentfile . "", "r");
                    $array_data = fgetcsv($file);
                    $content = $arrayValue[stristr($namefile, "_", true)] = (float) $array_data[0];
                    fclose($file);
                    $data = $this->airmodel->getAirByName($value);
                    ...
                    if ($namesearch == $value) {
                        ...
                        $param['month'] = $month;
                        $param['airdata'] = $content;
                        $param['airdataold'] = $airdata;
                        $param['unit'] = "μSv/h";
                        $param['idmonitor'] = $strname;
                        $this->airmodel->updateAirModel($param, $namesearch);

                        //update by day
                        $folder1 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYDATAUPDATE/$mon/";
                        $folder2 = $_SERVER["DOCUMENT_ROOT"] . "/Sharedfolder/Air_Space_DAYOLDDATA/$mon/";
//                                    $folder1 = $_SERVER["DOCUMENT_ROOT"]."/dataupdateold/";
//                                    $folder2 = $_SERVER["DOCUMENT_ROOT"]."/dataold/";
                        copy($folder1 . $currentfile, $folder2 . $currentfile);
                        unlink($folder1 . $currentfile);
            ...
            } else if ($strnameFileAir == "space.csv") {
                $namefile = $strdate . "" . $strnameFileAir;
                if (strlen($strdate) == 6) {
                    $year = substr($strdate, 0, 4);
                    $month = substr($strdate, 4, 2);
