...
<head>
  ...
  <title>  放射線安全管理部 | 九州大学アイソトープ総合センター</title>
...
<link rel="alternate" type="application/rss+xml" title="九州大学アイソトープ総合センター &raquo; 放射線安全管理部 のコメントのフィード" href="http://qu.workmanage.biz/system/radiation/feed" />
<link rel='canonical' href='<?php echo site_url('radiation')?>' />
<link rel='shortlink' href='http://qu.workmanage.biz/system/?p=108' />
...
<li id="menu-item-202" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-202"><a href="http://qu.workmanage.biz/system/inquiry">お問い合わせ</a></li>
          ...
          <div class="header-nav">
            <nav class="set-width">
              <ul >
                ...
                <li id="menu-item-200" class="g-nav1 menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-9 current_page_item menu-item-200"><a href="<?php echo site_url('radiation')?>">放射線安全管理部</a></li>
  ...
  <div class="contents page page-108">
    <div class="breadcrumbs set-width" xmlns:v="http://rdf.data-vocabulary.org/#">
        <!-- Breadcrumb NavXT 5.1.1 -->
<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Go to 九州大学アイソトープ総合センター." href="http://qu.workmanage.biz/system" class="home">TOP</a></span> &gt; <span typeof="v:Breadcrumb"><span property="v:title">放射線安全管理部</span></span>    </div>
