...
class chart {
    ...
    function draw_chart($params){
       ...
       // $Test->drawLegend(75,35,$DataSet->GetDataDescription(),255,255,255);   
        ...
        //$DataSet->SetYAxisUnit("μGy/h");
        //$DataSet->SetYAxisName("Response time");
        $DataSet->SetXAxisName($params['xname']);
        ...
        //$Test->drawRoundedRectangle(5,5,695,225,5,230,230,230);   
        $Test->drawGraphArea(255,255,255,FALSE);
        $Test->drawScale($DataSet->GetData(),$DataSet->GetDataDescription(),SCALE_NORMAL,150,150,150,TRUE,0,2,FALSE,1,FALSE,$params['type']);  
        $Test->drawGrid(1,TRUE,150,150,150,100,$params['type']);
        $Test->setLineStyle(2);
        // Draw the 0 line   
        $Test->setFontProperties(APPPATH."libraries/pChart/meiryob.ttc",6);   
        $Test->drawTreshold(0,143,55,72,TRUE,TRUE);   
