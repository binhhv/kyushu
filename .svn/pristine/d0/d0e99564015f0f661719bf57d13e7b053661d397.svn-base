...
<script>
   ...
   function getChartMon(b){
		...
		var titleGraph = '最新24時間線量'+'　'+town+ (mon%2 - 2)*-1 +'号機';
...
<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Go to 九州大学アイソトープ総合センター." href="http://qu.workmanage.biz/system" class="home">TOP</a></span> &gt; <span typeof="v:Breadcrumb"><span property="v:title">線量率</span></span>    </div>
...
<div class="box">
  ...
  <div class="box sen-box">
    ...
    <div id="map_canvas1" style="width:566px;height:300px;">Google Map2313123</div><br>
  ...
  <div class="row">
      <h5>加速器施設</h5>
      <div style="border: 1px solid #cfcfcf;margin: 10px;padding: 10px;text-align: center;height: 100px;">
         <label style="font-size: 26px;line-height: 90px;">準備中</label>
        ...
        <footer>
          <div class="footer-bg">
            <div class="set-width">
              ...
              <div class="footer-top row">
                <p class="left">[伊都地区実験室]<br>
                〒819-0395　福岡市西区元岡774<br>
                Tel 092-802-3990　Fax 092-802-3994　</p>
                <p class="left">[病院地区実験室]<br>
                〒812-8582　福岡市東区馬出3-1-1<br>
                Tel 092-642-6194　Fax 092-642-6200　</p>
                <p class="left">[箱崎地区実験室]<br>
                〒812-8581　福岡市東区箱崎6-10-1<br>
                Tel 092-642-2703　Fax 092-642-2706</p>
              </div>
            </div>
          </div>
